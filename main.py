...
with col_a:
    ...
    for _, row in sample.iterrows():
        color = '#6EE7B7' if row['INDE_2022'] > row['INDE_2020'] else '#F87171'
        fig.add_trace(go.Scatter(
            x=['2020','2021','2022'],
            y=[row['INDE_2020'],row['INDE_2021'],row['INDE_2022']],
            mode='lines', showlegend=False,
            line=dict(color=color.replace(')',',0.12)').replace('rgb','rgba') if 'rgb' in color else color+'1F', width=1),
        ))
    ...
    layout.update(height=340, yaxis_title="INDE", yaxis_range=[3,10],
...
with col_d:
    ...
    layout4.update(height=220, xaxis_title="Nº de alunos",
...
with col_e:
    ...
    layout5 = PLOTLY_LAYOUT.copy()
    layout5.update(height=300, xaxis_title="Número de evasões",
